...
- DeepSeek V4.1 Flash single-replica example (FN-D9 amendment, 2026-09-11) serves on TP8/SM120 with the V4 ReplicaPool/API/UI structure and official thinking-high default; initial reasoning/tool/vision/cancellation gates pass, while L1 selection and final serving/restart/long-context evidence remain pending in its `MEASUREMENTS.md`.
