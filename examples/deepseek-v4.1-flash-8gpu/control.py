#!/usr/bin/env python3
"""One-command lifecycle for DeepSeek-V4.1-Flash as one TP8 replica on eight GPUs."""
...
def _ensure_vllm_image(env: dict[str, str]) -> None:
    """Build and attest the pinned V4.1 runtime with official effort aliases."""
...
def up() -> None:
    ...
    print(
        ...
        f"({REPLICAS} TP8 replica, eight GPUs; text + image input; thinking high)"
    )
    print(
