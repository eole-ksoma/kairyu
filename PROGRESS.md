...
- DeepSeek V4.1 Flash single-replica example (FN-D9 amendment, 2026-09-11) is being implemented for TP8 on SM120, with the V4 ReplicaPool/API/UI structure and official thinking-high default; runtime and GPU selection evidence remain pending in its `MEASUREMENTS.md`.
